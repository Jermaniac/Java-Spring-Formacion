...
@EnableJpaRepositories(
		basePackages = {"cursojava.spring.datos.repositorio"},
		entityManagerFactoryRef = "entityManagerFactory",
		transactionManagerRef = "transactionManager"
		)
@ComponentScan(basePackages = "cursojava.spring.datos.rest")
@ConfigurationProperties(prefix = "cursojava.conexion")
...
//		mysqlPool.setUrl("jdbc:mysql://localhost:3306/MODELOBANCO");
...
//		mysqlPool.setPassword("Fedora2020");
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		.packages("cursojava.spring.datos.modelobanco.entidades")
		.persistenceUnit("modelobanco")
		.build();
